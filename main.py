...
os.environ["OPENAI_API_KEY"] = "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"
...
def generate_queries_chatgpt(original_query):
    ...
    response = ai_client.chat.completions.create(model="gpt-3.5-turbo",
        messages=[
...
def reciprocal_rank_fusion(search_results_dict, k=60):
    fused_scores = {}
    print("Initial individual   result ranks:")
